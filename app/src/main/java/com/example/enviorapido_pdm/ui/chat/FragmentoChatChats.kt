...
class FragmentoChatChats : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view : View = inflater.inflate(R.layout.fragment_fragmento_chat_chats, container, false)
        ...
        ref!!.addValueEventListener(object : ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (dataSnapShot in snapshot.children){
                    val chatList = dataSnapShot.getValue(ListaChatsModelo::class.java)
    ...
    private  fun RecuperarListaChat(){
